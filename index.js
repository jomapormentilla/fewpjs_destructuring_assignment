...
let newFarm = farmAnimals.split(" ")
newFarm.splice(1, 1)
const [Bessie, Dolly, Babe, Little] = newFarm
...
let byeLittle = newFarm
byeLittle.splice(3, 1)
const [black_and_white, black, pink] = byeLittle
// Arrays
...
let byeIndigo = colors.splice(5, 1)
const [r, o, y, g, b, v] = colors

// 6. But wait! Indigo is now feeling *super* left out. Let's only assign indigo using indg. 
const [indg] = byeIndigo
